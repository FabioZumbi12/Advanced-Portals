                        ...
                        if (portal.pos2.getX() <= loc.getX() && portal.pos2.getY() <= loc.getY() && portal.pos2.getZ() <= loc.getZ()) {
                            ...
                            if (!event.isCancelled()) {
                                ...
                                if (PortalMessagesDisplay == 1 && warped) {
                                    String dest = portal.destiation;
                                    if (portal.bungee != null){
                                	dest = portal.bungee;
                                    }
                                    player.sendMessage("");
                                    player.sendMessage(plugin.customPrefixFail + "\u00A7a You have been warped to \u00A7e" + dest.replaceAll("_", " ") + "\u00A7.");
                                    player.sendMessage("");
                                    ...
                                    plugin.nmsAccess.sendActionBarMessage("{\"text\":\"\u00A7aYou have been warped to \u00A7e" + dest.replaceAll("_", " ") + "\u00A7a.\"}", player);
